...
Traditioneel worden voor onderzoek vaak kopieën van medische dossiers naar één centrale database gestuurd. Dat brengt veel risico's met zich mee. PLUGIN draait dit om. Wij werken volgens het principe: **Data blijven bij de bron**.
...
**Meer lezen over PLUGIN als:**

<div class="grid cards" markdown>

- :lucide-user: __Data gebruiker__ <br>_Hoe kan ik PLUGIN gebruiken voor mijn project?_ [:octicons-arrow-right-24:](leeswijzer/data-gebruiker.md)
